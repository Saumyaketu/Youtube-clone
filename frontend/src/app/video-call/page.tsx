    ...
    <div className="min-h-[80vh] flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full bg-gray-900 border border-gray-800 rounded-2xl p-8 text-center shadow-2xl">
        ...
        <button
          ...
          className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition shadow-lg shadow-blue-600/30 mb-6"
        >
          New Meeting
        </button>
        ...
        <div className="relative flex items-center py-2 mb-6">
          ...
          <span className="shrink-0 mx-4 text-gray-500 text-sm">
        ...
        <form onSubmit={handleJoin} className="flex gap-2">
          <input
            ...
            className="grow px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white focus:outline-none focus:border-blue-500 transition"
          />
          <button
            type="submit"
            disabled={!joinId.trim()}
            className="px-6 py-3 bg-gray-700 hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold rounded-lg transition"
          >
            Join
          </button>
        </form>
