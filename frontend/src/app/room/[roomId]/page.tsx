      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-6">
        <div className="grow lg:w-3/4 flex flex-col gap-4">
          <div className="flex justify-between items-center bg-gray-900/50 p-4 rounded-xl border border-gray-800">
            <div>
              <h1 className="text-xl font-bold text-white">Live Watch Party</h1>
          ...
          <div className="bg-gray-900/30 p-4 rounded-xl mt-2">
        ...
        <div className="w-full lg:w-1/4 lg:min-w-[320px] lg:max-w-[400px]">
          <div className="sticky top-4">
            <h3 className="font-semibold mb-4 pl-2 text-gray-300 border-l-4 border-blue-500">
